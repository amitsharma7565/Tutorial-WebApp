 ...
 * 
 * @Configuration public class ApplicationConfiguration { private final
 * RegisterRepo userRepository;
 * 
 * public ApplicationConfiguration(RegisterRepo userRepository) {
 ...
 * 
 * @Bean BCryptPasswordEncoder securitypasswordEncoder() { return new
